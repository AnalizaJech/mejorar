    ...
    <Layout>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="relative">
            <div className="bg-gradient-to-r from-vet-primary via-vet-primary-dark to-vet-secondary rounded-3xl p-12 text-center relative overflow-hidden">
              {/* Background pattern */}
              <div className="absolute inset-0 opacity-10">
                ...
                <div className="absolute bottom-0 right-0 w-40 h-40 border border-white/10 rounded-full"></div>
                <div className="absolute bottom-10 left-10 w-20 h-20 border border-white/20 rounded-full"></div>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-xl text-white/90 mb-10 max-w-3xl mx-auto leading-relaxed">
                  Nuestro equipo de veterinarios certificados está disponible para brindar
                  el mejor cuidado con la tecnología más avanzada.
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  {isAuthenticated ? (
                    <Link to="/nueva-cita">
                      <Button size="lg" className="bg-white text-vet-primary hover:bg-vet-gray-50 px-8 py-6 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all duration-300">
                  ...
                  <a href="#emergencias">
                    <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-vet-primary px-8 py-6 text-lg font-semibold">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 pt-8 border-t border-white/20">
                  <div className="text-center">
                    ...
                    <div className="text-white/80">Mascotas Atendidas</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white mb-2">24/7</div>
                    <div className="text-white/80">Servicio de Emergencias</div>
                  </div>
                  <div className="text-center">
