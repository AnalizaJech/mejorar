  ...
  return (
    <Layout>
      ...
      <ConfirmationModal
        ...
        title="Eliminar cita"
        description={`¿Est��s seguro de que quieres eliminar la cita de ${citaToDelete?.mascota}? Esta acción no se puede deshacer.`}
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedContactCita &&
                (() => {
                  const propietario = usuarios.find(
                    (u) => u.id === selectedContactCita.clienteId,
                  );
                  return propietario
                  ...
                  <div className="grid gap-3">
                    ...
                    <div className="bg-vet-gray-50 rounded-lg p-4 mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-vet-gray-600">
                            Cita: {selectedContactCita.mascota} -{" "}
                            {new Date(
                              selectedContactCita.fecha,
                    ...
                    {propietario.telefono && (
                      <>
                        <Button
                          ...
                          onClick={() => {
                            const phoneNumber = propietario.telefono.replace(
                              /\D/g,
                              "",
                            );
                    ...
                    {propietario.email && (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          window.open(
                            `mailto:${propietario.email}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`,
                            "_self",
                          );
                          setShowContactModal(false);
                        }}
                    ...
                    {!propietario.telefono && !propietario.email && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-vet-gray-600">
                          No hay información de contacto disponible para este
                          propietario.
                        </p>
                      </div>
                    )}
